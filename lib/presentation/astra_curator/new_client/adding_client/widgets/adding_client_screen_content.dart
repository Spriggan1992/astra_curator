...
import 'package:astra_curator/presentation/astra_curator/new_client/adding_client/widgets/adding_photo_sign.dart';
import 'package:astra_curator/presentation/astra_curator/new_client/adding_client/widgets/photos.dart';
                ...
                return Column(
                  children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextFieldPopUpMenu(
                            ...
                            items: const [
                              GenderModel(
                                title: Constants.genderMale,
                                value: 1,
                              ),
                              GenderModel(
                                title: Constants.genderFemale,
                                value: 2,
                              ),
                            ],
                            onSelected: (selectedItem) =>
                    ...
                    TextFieldPopUpMenu(
                      ...
                      hint: Constants.martialStatus,
                      items: const [
                        MartialStatusModel(
                            title: Constants.martialStatusSingle, value: 0),
                        MartialStatusModel(
                            title: Constants.martialStatusDivorced, value: 1),
                      ],
                      onSelected: (selectedItem) =>
                          context.read<AddingClientBloc>().add(
                    ...
                    TextFieldPopUpMenu(
                      ...
                      hint: Constants.haveChild,
                      items: const [
                        ChildStatusModel(
                            title: Constants.haveChildFalse, value: false),
                        ChildStatusModel(
                            title: Constants.haveChildTrue, value: true),
                      ],
                      onSelected: (selectedItem) =>
                          context.read<AddingClientBloc>().add(
                    ...
                    SizedBox(
                      ...
                      child: Align(
                        ...
                        child: LostFocusTextField(
                          ...
                          hint: Constants.shortDescription,
